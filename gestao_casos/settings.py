"""
Django settings for gestao_casos project.
...
SECRET_KEY = 'django-insecure-y*d6udw4@%r741^6%retxtu&7js=ra92mv)hevk7(zozca0lj$'
...
# Adicione esta lógica logo abaixo da configuração de DATABASES
